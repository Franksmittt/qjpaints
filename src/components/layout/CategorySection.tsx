// src/components/layout/CategorySection.tsx - FULL REPLACEMENT (Reverted to 3 Columns & Asterisks Removed)
...
import { ArrowRight, Paintbrush, Factory, Car } from "lucide-react"; // Wrench removed
import { cn } from "@/lib/utils"

// Data structure updated to 3 verticals
const verticals = [
  {
    title: "Decorative Paint",
    description:
      "Premium interior and exterior systems. Your local official stockist for Top Paints, Flash Harry, and ILEX. Full range, expert color advice.",
  ...
  },
  {
    ...
    description:
      "High-performance refinish systems for professional bodyshops. We supply superior mipa and HB BODY systems, backed by our spectrophotometer matching service.",
  ...
  },
  {
    ...
    description:
      "Heavy-duty, specified solutions for asset protection. Official stockist for Amalgamated Paints and Paintchem industrial systems, including epoxy floor coatings.",
...
export function CategorySection() {
  return (
    ...
    <section className="w-full bg-secondary/10 py-16 md:py-24 dark:bg-neutral-950 transition-colors duration-500">
        ...
        {/* Section Header (Storyteller's Heart: Clarity and Focus) */}
         <div className="mx-auto mb-12 max-w-4xl text-center">
          ...
          <p className="mt-4 text-xl leading-8 text-neutral-600 dark:text-neutral-300">
            We are the only supplier in the region providing expert consultation and supplies for decorative, automotive, and industrial projects under one roof.
          </p>
        </div>
