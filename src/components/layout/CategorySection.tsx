// src/components/layout/CategorySection.tsx - FULL REPLACEMENT (Brand Replacement)
...
const verticals = [
  {
    ...
    description:
      "Premium interior and exterior systems. Your local official stockist for **PAINTCHEM, Top Paints, and Q-Bond**. Full range, expert color advice.",
  ...
  },
  {
    ...
    description:
      "Heavy-duty, specified solutions for asset protection. **SHIELD** anti-corrosion primers, epoxy floor coatings, and specialized systems for mining and manufacturing.",
