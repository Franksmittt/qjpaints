...
const approvedContractors = [
  {
    name: "Johannesburg Epoxy Solutions",
    vertical: "Industrial",
    specialty: "Epoxy Flooring, Wadeville",
  },
  {
    name: "Alberton Quality Painters",
    vertical: "Decorative",
    specialty: "High-end Residential, Dulux Trade",
  },
  {
    name: "Swift Auto Body",
    vertical: "Automotive",
    specialty: "R-M Refinish Certified, Boksburg",
  },
  {
        ...
        <div className="container max-w-screen-lg">
          ...
          <div className="mt-16 text-center border-t pt-8">
            ...
            <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
                The only way to join this exclusive list is to become a QJ Trade Partner. We send you the leads!
            </p>
