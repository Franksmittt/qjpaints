// src/app/trade-partner-program/page.tsx
...
export default function TradePartnerProgramPage() {
  return (
    <main>
      ...
      {/* Hero Section: The Moat (Storyteller's Heart: Value and Loyalty) */}
        ...
        <div className="container max-w-screen-xl grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-lg text-neutral-600 dark:text-neutral-400">
              Our marketing drives homeowners and businesses to the QJ website looking for experts.
              Instead of keeping those leads, **we send them directly to you** via our **QJ-Approved Contractor Directory**.
            </p>
