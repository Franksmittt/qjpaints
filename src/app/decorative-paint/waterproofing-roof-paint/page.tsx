...
// FIX: 'Home' removed from this import
import { Waves, CloudRain, MoveRight, Layers } from "lucide-react";
...
export const metadata = {
  title: "Waterproofing & Roof Paint Solutions Alberton | QJ Paint World",
  description: "Specialist supplier of high-performance roof paints, sealants, and waterproofing systems. Protect your home and assets against the South African weather.",
};
...
const protectionTypes = [
  ...
  },
  {
    ...
    description: "Fiber-reinforced liquid membranes ideal for complicated flashings, parapet walls, and areas where traditional sheeting fails.",
  },
  {
    icon: Layers,
    title: "Surface Preparation",
    description: "The most critical step: cleaners and primers engineered for high adhesion and maximum system longevity.",
  },
];
    ...
    <main>
      ...
      <section className="bg-white py-16 md:py-24 dark:bg-neutral-900 text-neutral-900 dark:text-white">
        <div className="container max-w-screen-xl grid md:grid-cols-2 gap-12 items-center">
          <div>
            <span className="text-sm font-semibold uppercase text-primary">Weather Protection Solutions</span>
            ...
            <p className="mt-4 text-xl text-neutral-600 dark:text-neutral-300 max-w-lg">
              The roof is your first line of defense. We supply specialist elastomeric roof paints and liquid waterproofing systems certified to withstand the harsh South African climate.
           </p>
            <div className="mt-8 flex gap-4">
              <Button asChild size="lg" className="bg-primary hover:bg-primary/90">
                <Link href="#solutions">Explore Products</Link>
              </Button>
      ...
      <section id="solutions" className="py-16 md:py-24 bg-secondary/10 dark:bg-neutral-800">
        <div className="container">
          <h2 className="text-3xl font-bold text-center mb-12">The Right System for the Job</h2>
      ...
      <section className="py-16 bg-accent dark:bg-accent/80 text-white">
        <div className="container text-center">
          ...
          <p className="mt-2 text-xl font-medium">
            For high-stakes commercial or industrial flat roofs, check our Anti-Corrosion hub for heavy-duty Polyurea systems.
          </p>
