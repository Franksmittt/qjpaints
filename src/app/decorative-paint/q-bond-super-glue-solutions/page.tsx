// src/app/decorative-paint/q-bond-super-glue-solutions/page.tsx - NEW FILE

import Image from "next/image";
import { MoveRight, HardHat, LinkIcon, Settings } from "lucide-react"; // Removed Package
    ...
    <main>
          ...
          <div className="order-2 md:order-1">
            ...
            <div className="mt-8 flex gap-4">
              ...
              <Button asChild variant="outline" size="lg" className="border-accent text-accent hover:bg-accent hover:text-white">
                <Link href="/decorative-paint/paintchem-trade-supplier">View PAINTCHEM Paints →</Link>
              </Button>
            </div>
          </div>
      ...
      <section className="py-16 bg-secondary/10 dark:bg-neutral-900">
        <div className="container text-center">
          <h2 className="text-3xl font-bold text-neutral-900 dark:text-white">Need Fillers and Adhesives for Automotive Repairs?</h2>
          <p className="mt-2 text-xl font-medium text-neutral-600 dark:text-neutral-300">
            Q-Bond is often paired with our HB BODY fillers and mipa paint systems.
          </p>
          <Button asChild size="lg" className="mt-6 bg-accent text-white hover:bg-accent/90">
            <Link href="/automotive-paint/hb-body-consumables">
              View All Automotive Consumables <MoveRight className="ml-2 h-5 w-5" />
            </Link>
          </Button>
        </div>
      </section>
