...
export default function ExpertColourMatchingPage() {
  return (
    <main>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="order-2 md:order-1 w-full px-4 sm:px-0">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                ...
                <Button asChild 
                  variant="link" 
                  size="lg" className="text-accent hover:text-accent/80 whitespace-nowrap">
      ...
      <section id="process" className="py-12 sm:py-16 md:py-24 bg-white dark:bg-neutral-800">
        <div className="container">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12">Our Guaranteed 4-Step Matching Process</h2>
      ...
      <section className="py-16 bg-primary dark:bg-primary/90 text-neutral-900">
        <div className="container text-center">
           <h2 className="text-2xl sm:text-3xl font-bold">This Service Supports All Your Projects</h2>
