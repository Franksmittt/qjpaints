...
// FIX: 'AlertTriangle' removed from this import
import { Shield, Hammer, MoveRight, Layers } from "lucide-react";
import { Button } from "@/components/ui/button";
import Link from "next/link";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";

export const metadata = {
  title: "Anti-Corrosion Coatings & Steel Protection Johannesburg | QJ Industrial",
  description: "Specialized supplier of anti-corrosion and protective coatings for steel in mining and manufacturing. Solutions include Zinc-Rich Primers and DTM systems for asset protection.",
};
...
const solutionHighlights = [
  ...
  },
  {
    ...
    description: "Tough topcoats formulated to withstand mechanical impact and friction typical of heavy manufacturing and port operations.",
  },
];
    ...
    <main>
      ...
      <section className="bg-neutral-900 py-16 md:py-24 text-white">
        <div className="container max-w-screen-xl grid md:grid-cols-2 gap-12 items-center">
          <div>
            <span className="text-sm font-semibold uppercase text-accent">High-Stakes Asset Protection</span>
            ...
            <p className="mt-4 text-xl text-neutral-300 max-w-lg">
              Corrosion costs money and downtime. We partner with engineers and specifiers to provide **certified protective systems** that guarantee the longevity of your steel assets in the harshest environments.
            </p>
            <div className="mt-8 flex gap-4">
              <Button asChild size="lg" className="bg-primary hover:bg-primary/90">
                <Link href="/contact-us">Request On-Site Specification</Link>
              </Button>
      ...
      <section className="py-16 md:py-24 bg-white dark:bg-neutral-800">
        <div className="container">
          <h2 className="text-3xl font-bold text-center mb-12">Certified Solutions for Mining & Manufacturing</h2>
